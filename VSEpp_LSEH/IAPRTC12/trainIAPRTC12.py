...
from IAPRTC12.evaluationIAPRTC12 import i2t, t2i, AverageMeter, LogCollector, encode_data
...
def main():
    ...
    parser.add_argument('--learning_rate', default=.0008, type=float,
                        help='Initial learning rate.')#0.0002
    parser.add_argument('--lr_update', default=8, type=int,
                        help='Number of epochs to update the learning rate.')#15
    ...
    parser.add_argument('--img_dim', default=36*2048, type=int,
    ...
    if opt.data_name == 'iaprtc12_precomp':
        opt.data_name = 'f30k_precomp' # as f30k setteings
