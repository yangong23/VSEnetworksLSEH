...
class PrecompDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return image, captions, bboxes, depend, index, img_id, lsa
...
def collate_fn(data):
    ...
    images, captions, bboxes, depends, ids, img_ids, lsa = zip(*data)
    ...
    return images, targets, bboxes, depends, lengths, ids, img_ids, lsa
