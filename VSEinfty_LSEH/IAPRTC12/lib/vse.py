...
from lib.loss import ContrastiveLoss, ContrastiveLossLSEH
...
class VSEModel(object):
    ...
    def forward_loss(self, img_emb, cap_emb, ids, img_ids, lsa):
        """Compute the loss given pairs of image and caption embeddings
        """
        loss, lossS, lossIm = self.criterion(img_emb, cap_emb, ids, img_ids, lsa)
    ...
    def train_emb(self, images, captions, lengths, ids, img_ids, lsa, image_lengths=None, warmup_alpha=None):
        ...
        loss = self.forward_loss(img_emb, cap_emb, ids, img_ids, lsa)
