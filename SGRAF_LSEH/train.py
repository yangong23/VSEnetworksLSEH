...
def validate(opt, val_loader, model):
    ...
    tb_logger.log_value('Sum of Recall', r_sum, step=model.Eiters)
    tb_logger.log_value('Sum of Recall (i2t)', r_sum1, step=model.Eiters)
    tb_logger.log_value('Sum of Recall (t2i)', r_sum2, step=model.Eiters)
