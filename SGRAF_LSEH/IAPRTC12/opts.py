...
def parse_opt():
    ...
    # --------------------------- data path -------------------------#
    parser.add_argument('--data_path', default='/home/lunet/coyg4/data/iaprtc12',
                        help='path to datasets')
    parser.add_argument('--data_name', default='iaprtc12_precomp',
                        help='{coco,f30k}_precomp')
    parser.add_argument('--vocab_path', default='./vocab/',
                        help='Path to saved vocabulary json files.')
    parser.add_argument('--model_name', default='./runs/iaprtc12_SGR/checkpoint',
                        help='Path to save the model.')
    parser.add_argument('--logger_name', default='./runs/iaprtc12_SGR/checkpoint',
